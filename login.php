...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM vartotojai WHERE username = :username";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
    ...
    <section class="wrapper " style="padding-top:10rem;margin: auto">
        <h2>Prisijungti</h2>
        <p>Užpildykite su savo prisijungimo duomenimis ir prisijunkite.</p>
        <?php 
        if(!empty($login_err)){
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Neturite paskyros? <a href="register.php">Užsiregistruokite</a>.</p>
        </form>
    </section>
</body>
</html>