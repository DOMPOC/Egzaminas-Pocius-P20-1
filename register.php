...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM vartotojai WHERE username = :username";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO vartotojai (username, password) VALUES (:username, :password)";
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav">
    ...
    <div class="wrapper" style="padding-top:10rem;margin: auto" >
        <h2>Užsiregistruokite</h2>
        <p>Užpildykite šią formą, kad užsiregistruotumėte.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Jau turite paskyra? <a href="login.php">Prisijunkite čia</a>.</p>
        </form>
    </div>   
</body>
</html>